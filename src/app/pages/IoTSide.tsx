...
>
              ...
              {[
  {
    ...
    tags: ['ESP32', 'LoRa SX1278', 'PCB Design', 'Dashboard UX', 'Figma'],
  ...
  {
    title: 'Tremor Assistance Glove',
    subtitle: 'UX for Assistive Hardware',
    desc: 'Designing the companion interface for a tremor-assistance wearable glove — translating sensor data and device controls into an accessible, calm UI for users with motor impairments.',
    tags: ['Assistive Tech', 'PCB Design', 'Figma', 'Wearables'],
    status: 'Ongoing',
    accent: '#378ADD',
